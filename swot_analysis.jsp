...
<body class="mfbg" id="page-top">
      ...
      <ol class="breadcrumb" style="background-color:transparent;">
        ...
        <li class="breadcrumb-item active">Mentoring&nbsp; / &nbsp;SWOT Analysis</li>
      </ol>
	  
	  
<div class="container">
      <!-- main content-->
	  <form action="swot_analysis" method="post" name="form_swot_analysis" target="display_frame">		
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<input class="form-control" id="studentname" name="name" type="text" value="<%=(String)request.getSession().getAttribute("user_name")%>" style="background-color:white;"  readonly>
						</div>
						<div class="col-sm-2">
