				...
				<div class="container">
					<table class="table table">
						...
						<tbody>
							<tr>
								<td><br>
									...
									<div class="row">
										...
										<input class="form-control" id="staffname" name="staffname" type="text">
										</div>
										<div class="col-sm-2">
										<label for="staffid"><b>Staff Id <span class="text-danger">*</span></b></label>
										<input class="form-control" id="staffid" name="staffid" value="<%=request.getSession().getAttribute("user_id")%>" style="background-color:white;"  readonly type="text">
										</div>
										...
										<div class="col-sm-1">
											<label><b>Age<span class="text-danger">*</span></b></label>
											   <input class="form-control" type="text" name="age" maxlength="7" value=""  readonly maxlength="1"  id="years">
										</div>
										<div class="col-sm-2">
								...
								<tbody>
									...
									<tr>
										<div class="row">
											...
											<textarea class="form-control" rows="3" id="paper_national" name="paper_national"></textarea></div></td>
											<td><div><label for="comment"><strong>International</strong></label>
											<textarea class="form-control" rows="3" id="paper_international" name="paper_international"></textarea></div></td>
										</div>
									</tr>	
									<tr class="tbodyrow">
										<th style='font-size: 18px;color: #33A8FF;line-height: 1.2;font-weight: unset;'colspan='2'>
									...
									<tr>
										<div class="row">
											<td><div><label for="comment"><strong>National</strong></label>
											<textarea class="form-control" rows="3" id="national1" name="conference_national"></textarea></div></td>
											<td><div><label for="comment"><strong>International</strong></label>
											<textarea class="form-control" rows="3" id="international1" name="conference_international"></textarea></div></td>
										</div>
									</tr>
								</tbody>
							</table><br>
							...
							<div class="col-sm-3">
									<textarea class="form-control" rows="5" id="professionalbodies" name="professionalbodies"></textarea>
								</div>
								<div style='text-align:right;'class="col-sm-2">
									<label for="consultations"><b>Consultations <span class="text-danger">*</span> :</b></label>
								</div>
								<div class="col-sm-4">
									<textarea class="form-control" rows="5" id="consultations" name="consultations"></textarea>
								</div>
							</div><br>
							<div class="row">
							<div style='text-align:right;'class="col-sm-3">
								...
								<div class="col-sm-3">
									<textarea class="form-control" rows="5" id="research" name="research"></textarea>
								</div>
								<div style='text-align:right;'class="col-sm-2">
									<label for="studentname"><b>Other Interests <span class="text-danger">*</span> :</b></label>
								</div>
								<div class="col-sm-4">
									<textarea class="form-control" rows="5" id="otherinterests" name="otherinterests"></textarea>
								</div>
							</div>	
