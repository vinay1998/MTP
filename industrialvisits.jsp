...
<body class="mfbg" id="page-top">
      ...
      <ol class="breadcrumb" style="background-color:transparent;">
        ...
        <li class="breadcrumb-item active">ECA & CCA&nbsp; / &nbsp;Industrial Visits</li>
      </ol>
      <!-- main content-->
	  
		
<div class="container">
	<form action="industrialvisits"  method="post" name="form1" onsubmit="document.form1.target='display_frame';return true;">	
		<div class="form-group">
			...
			<table class="table table-hover" id='data'>
				...
				<tbody>
					<div class="row">
						<tr class="tbodyrow">
							<div class='col-sm-3'><td><textarea class='form-control subsave-area' rows='2' cols='50' maxlength="1000" name='nameoftheindustryvisited' id='id_nameoftheindustryvisited' ></textarea><p id="max-name">0/1000</p></td></div>
							<div class='col-sm-2'>
								<td>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){ 
     ...
     $('#id_nameoftheindustryvisited,#id_learningpoints,#id_actionplan').on("input",function ()  {
		...
		if($('#id_nameoftheindustryvisited').val().length <= 1000)
		{
		  $('#max-name').text($('#id_nameoftheindustryvisited').val().length+'/1000');
		}
