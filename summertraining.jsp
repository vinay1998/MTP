...
<body style="background-color:transparent;">
      ...
      <ol class="breadcrumb" style="background-color:transparent;">
        ...
        <li class="breadcrumb-item active">ECA & CCA&nbsp; / &nbsp;Summer Training Visits</li>
      </ol>
	  
	  
    <!-- main content-->
	<div class="container">
		<form action="summertraining"  method="post" name="form1" onsubmit="document.form1.target='display_frame';return true;">	
