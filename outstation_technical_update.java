	...
	//table head code
		...
		while(rs.next())
		{
			...
			if(req.getParameter(String.valueOf(rs.getInt(5)))!=null)
			{
				...
				out.print("<div class='col-sm-3'><td><textarea class='form-group' style='background-color:white;'  rows='3' cols='35' name='learningpoints1'>"+rs.getString(3)+"</textarea></td></div><div class='col-sm-3'><td><textarea class='form-group' style='background-color:white;'  rows='3' cols='35' name='actionplan1'>"+rs.getString(4)+"</textarea></td></div></tr>");			
