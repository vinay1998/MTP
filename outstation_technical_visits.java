  ...
  public void service(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
  {
	...
	try
    {
		...
		if(req.getParameter("save")!=null)
		{
			...
			out.print("<body class='sfbg'><form action='outstation_update' target='_self'><table class='table table-hover' id='data'><thead><div class='row'><tr class='table100-head theadrow'>");
			...
			while(rs.next())
			{	
				out.print("<tr class='tbodyrow'><div class='col-sm-3'><td><textarea class='form-group' style='background-color:white;'  rows='3' cols='25' disabled>"+rs.getString(1)+"</textarea></td><div class='col-sm-3'><td><p>"+rs.getString(2)+"</p></td></div><div class='col-sm-3'><td><textarea class='form-group' style='background-color:white;'  rows='3' cols='35' disabled>"+rs.getString(3)+"</textarea></td></div><div class='col-sm-3'><td><textarea class='form-group' style='background-color:white;'  rows='3' cols='35' disabled>"+rs.getString(4)+"</textarea></td></div><div class='col-sm-1'><td><button type='submit' class='btn btn-primary' name='"+rs.getInt(5)+"'>Edit</button></td></div></tr>");			
		...
		else if(req.getParameter("search")!=null)
		{
			...
			if(rs.isBeforeFirst())
			{
				...
				while(rs.next())
				{	
					out.print("<tr class='tbodyrow'><div class='col-sm-3'><td><textarea class='form-group' style='background-color:white;'  rows='3' cols='25' disabled>"+rs.getString(1)+"</textarea></td><div class='col-sm-3'><td><p>"+rs.getString(2)+"</p></td></div><div class='col-sm-3'><td><textarea class='form-group' style='background-color:white;'  rows='3' cols='35' disabled>"+rs.getString(3)+"</textarea></td></div><div class='col-sm-3'><td><textarea class='form-group' style='background-color:white;'  rows='3' cols='35' disabled>"+rs.getString(4)+"</textarea></td></div><div class='col-sm-1'><td><button type='submit' name='"+rs.getInt(5)+"' class='btn btn-primary'>Edit</button></td></div></tr>");			
