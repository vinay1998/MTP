...
<body class="mfbg" id="page-top">
      ...
      <!-- main content-->
<div class="container">	
	<form action="attendance" method="post" name="form_attendance" target="display_frame">		
				...
				<div class="form-group">
					<div class="row">
						...
						<div class="col-sm-4">
							...
							<input class="form-control" name="studentname" id="studentname" type="text" value="<%=(String)request.getSession().getAttribute("user_name")%>"  style="background-color:white;" readonly>
						</div>
						<div class="col-sm-2">
